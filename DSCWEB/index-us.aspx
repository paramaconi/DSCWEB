<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index-us.aspx.cs" Inherits="DSCWEB.index_us" %>
              ...
              <ul class="nav navbar-nav navbar-nav-onepager">
                ...
                <li class="nav-item">
                  <a href="#about" data-toggle="scroll-link" class="nav-link link-effect-slideup"> 
                      <span class="nav-link-inner" data-title="About Us">About Us</span> </a>
                </li>
                <li class="nav-item">
                  <a href="#features" data-toggle="scroll-link" class="nav-link link-effect-slideup"> 
                      <span class="nav-link-inner" data-title="Our strengths">Our strengths</span> </a>
                </li>
                <li class="nav-item">
                  <a href="#pricing" data-toggle="scroll-link" class="nav-link link-effect-slideup"> 
                      <span class="nav-link-inner" data-title="We do it like this">We do it like this</span> </a>
                </li>
                <li class="nav-item">
                  <a href="#projects" data-toggle="scroll-link" class="nav-link link-effect-slideup"> 
                      <span class="nav-link-inner" data-title="Projects">Projects</span> </a>
                </li>
                <li class="nav-item">
                  <a href="#alliances" data-toggle="scroll-link" class="nav-link link-effect-slideup"> <span class="nav-link-inner" data-title="Partners">Partners</span> </a>
                </li>
                <li class="nav-item">
                  <a href="#contact" data-toggle="scroll-link" class="nav-link link-effect-slideup"> 
                      <span class="nav-link-inner" data-title="Contact">Contact</span> </a>
                </li>
                <li class="nav-item">
                   <a href="index.aspx" class="nav-link link-effect-slideup"><i class="flag-icon flag-icon-es"></i></a>
                </li>
              </ul>
            </div>
            <!--/.navbar-collapse -->
  ...
  <div id="highlighted">
    ...
    <div class="bg-white overlay overlay-primary overlay-op-7 text-center px-3 py-5 py-lg-10 flex-valign" data-toggle="backstretch" data-backstretch-target="self" data-backstretch-overlay=false data-backstretch-imgs="assets/img/backgrounds/man-with-open-arms-saluting-the-nature-picjumbo-com.jpg,assets/img/backgrounds/ysvazfxdz_8-alvaro-serrano.jpg,assets/img/backgrounds/zfg9gz7ylcu-dalibor-bosnjakovic.jpg">
      <h2 class="display-4 text-white" data-animate="fadeIn" data-animate-delay="0.2">
        <span class="font-weight-bold">Itabos is Design Software Community</span>
      </h2>
      <h3 class="text-grey font-weight-normal" data-animate="fadeIn" data-animate-delay="0.35">
        The sky is the limit... Start your next project with us!
      </h3>
      <hr class="hr-inverse hr-lg w-20 mx-auto my-4" data-animate="fadeIn" data-animate-delay="0.45" />
      <div> <a href="#about" class="btn btn-dark btn-rounded btn-lg py-lg-3 px-lg-5" data-toggle="scroll-link" data-animate="fadeIn" data-animate-delay="0.55">More...</a>
      </div>
    </div>
  </div>
      ...
      <div class="container">
        <div data-animate="fadeIn" data-animate-duration="0.8">
          ...
          <h2 class="text-center text-uppercase font-weight-bold my-0">
            We are <span class="text-shadow">ITABOS</span>
          </h2>
        ...
        <div class="row">
          <div class="col-md-6" data-animate="fadeIn" data-animate-delay="0.4" data-animate-offset="100%">
           <!--  <p class="lead">At lucidus qui. Jus mos neque.</p> -->
            <p style="text-align: justify;">We are a software development and technology solutions company,
                 providing innovative responses to the challenges of modern industry,
                 managing with Agile methodologies all the necessary processes to meet these challenges in a timely manner...
            </p>
            <p class="mb-0"> create community and empathizing with our business partners is our priority.</p>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-4 py-5" data-animate="fadeIn" data-animate-delay="0.3">
              ...
              <h2 class="display-4 text-slab text-white text-uppercase mt-0 mb-5">
                Choose <span class="text-primary font-weight-bold">ITABOS</span>
              </h2>
              <div class="row mb-3">
                ...
                <div class="col-10 col-md-11 text-grey">
                  ...
                  <p style="text-align: justify;">Our commitment is to be a tangible part of your organization so that we can understand your processes and integrate ourselves into your model business.</p>
                </div>
              </div>
              <div class="row mb-3">
                <div class="col-2 col-md-1 text-center"> <i class="fa fa-check text-primary icon-2x"></i>
                ...
                <div class="col-10 col-md-11 text-grey">
                  ...
                  <p style="text-align: justify;">An essential ingredient in our solutions, with fresh ideas that accelerate the progress of your organization.</p>
                </div>
              </div>
              <div class="row mb-3">
                <div class="col-2 col-md-1 text-center"> <i class="fa fa-check text-primary icon-2x"></i>
 ...
 <!-- Features -->
    <div id="features" class="container py-4 py-lg-6">
      <div data-animate="fadeIn" data-animate-duration="0.6">
        ...
        <h5 class="text-center font-weight-light mt-2 mb-0 text-muted">
         All this to create great products!
        </h5>
        <hr class="mb-5 w-50 mx-auto" />
      </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              ...
              <div class="row align-items-center mb-4 no-gutters">
                ...
                <div class="col-md-10">
                  <h5 class="mt-0">
                    Multiplatform Applications (Hybrid)
                  </h5>
                  <div class="progress">
    ...
    <div id="pricing" class="bg-light py-3 py-lg-6">
      <div class="container">
        <div data-animate="fadeIn" data-animate-duration="0.6">
          ...
          <h5 class="text-center font-weight-light mt-2 mb-0 text-muted">
            Linear processes and translation 
          </h5>
          <hr class="mb-5 w-50 mx-auto" />
        </div>
        <div class="row pricing-stack">
          <div class="col-md-3" data-animate="fadeIn" data-animate-delay="0.2">
            <div class="card bg-shadow text-center border-0">
              ...
              <p class="price-banner bg-light shadow-sm card-body-overlap"> <span class="price-digits">Analysis</span></p>
              <div class="card-body">
          ...
          <div class="col-md-3" data-animate="fadeIn" data-animate-delay="0.3">
            <div class="card bg-white bg-shadow text-center rounded-0 border-0 border-top-3-primary">
              ...
              <span class="price-digits">Development</span></p>
              <div class="card-body">
                <ul class="list-unstyled text-sm text-black-50">
          ...
          <div class="col-md-3" data-animate="fadeIn" data-animate-delay="0.4">
            <div class="card bg-white bg-shadow text-center rounded-0 border-0 border-top-3-primary">
              ...
              <p class="price-banner bg-light shadow-sm card-body-overlap">
                <span class="price-digits">Activation</span>                
              </p>
              <div class="card-body">
                <ul class="list-unstyled text-sm text-black-50">
                  <li>Deliveries on time</li>
                  <li>99.9% Operating</li>
                  <li>Greater added value!!</li>                  
                </ul>
                <!-- <a href="#" class="btn btn-primary btn-rounded btn-lg mt-4">Sign Up</a> -->
              </div>
            </div>
          ...
          <div class="col-md-3" data-animate="fadeIn" data-animate-delay="0.5">
            <div class="card bg-shadow text-center border-0">
              ...
              <p class="price-banner bg-light shadow-sm card-body-overlap">                
                <span class="price-digits">Support</span>
              </p>
              <div class="card-body">
                <ul class="list-unstyled text-sm text-black-50">
                  <li>Support plans</li>
    ...
    <div class="p-3 p-lg-5  text-center" data-bg-video="assets/videos/bubbles.mp4" data-animate="fadeIn">
      <div class="container">
        <h2 class="text-white display-4 text-shadow">
          Add a little <span class="font-italic font-weight-bold">effervescence</span> to your next project!
        </h2>
    ...
    <div id="projects" class="container p-3 py-lg-6" data-toggle="magnific-popup" data-magnific-popup-settings='{"delegate": "a.project", "gallery":{"enabled":true}}'>
      ...
      <div class="mt-4 owl-nav-over owl-nav-over-lg owl-dots-center" data-toggle="owl-carousel" data-owl-carousel-settings='{"responsive":{"0":{"items":1, "nav":false, "dots":true}, "600":{"items":2, "dots":true}, "940":{"items":3, "nav":true, "dots":true}}, "margin":1, "nav":true, "dots":false}'>
        ...
        <!--Project item 1-->
        <a href="assets/img/projects/sapa1us.jpg" class="project overlay-hover">
          <img src="assets/img/projects/sapa1us-sm.jpg" alt="Project 1" class="img-fluid" />
          <span class="overlay-hover-content">
            <i class="fa fa-arrow-circle-right icon-3x text-white"></i>
            <h5 class="mt-4">
             Loan and Rental Administration System (SAPA)             
            </h5>
          </span>
        </a>

        <!--Project item 2-->
        <a href="assets/img/projects/valuamos1us.jpg" class="project overlay-hover">
          <img src="assets/img/projects/valuamos1us-sm.jpg" alt="Project 2" class="img-fluid" />
          <span class="overlay-hover-content">
            <i class="fa fa-arrow-circle-right icon-3x text-white"></i>
            <h5 class="mt-4">
        ...
        <!--Project item 3-->
        <a href="assets/img/projects/satori1us.jpg" class="project overlay-hover">
          <img src="assets/img/projects/satori1us-sm.jpg" alt="Project 3" class="img-fluid" />
          <span class="overlay-hover-content">
            <i class="fa fa-arrow-circle-right icon-3x text-white"></i>
            <h5 class="mt-4">
              Electronic billing (Costa Rica)
            </h5>
          </span>
        </a>
      </div>
      ...
      <div class="container">
        <div data-animate="fadeIn" data-animate-duration="0.6">
          ...
          <h5 class="text-center font-weight-light mt-2 mb-0 text-grey">
            To expand the scope of our solutions, we create alliances that allow us to provide a better service
          </h5>
          <hr class="mb-5 w-50 mx-auto" />
        </div>
              ...
              <div class="card p-3 col-sm-4">
                  ...
                  <div class="card-body">
                      <p class="card-text text-center">
                          Strategic partner in Digital Marketing, our ideal complement
                          to move your brand to the Internet
                      </p>
                  </div>
              </div>
          </div>
        ...
        <div class="row" data-animate="fadeIn" data-animate-delay="0.1">
          ...
          <div class="col-md-6">
            <form id="formc" runat="server">
                ...
                <input type="text" class="form-control" id="name" placeholder="Name" required="required" runat="server"/>
              </div>
              ...
              <div class="form-group" data-animate="fadeInDown" data-animate-delay="0.4">
                ...
                <textarea rows="5" class="form-control" id="message" placeholder="Message" required="required"  runat="server"></textarea>
              </div>
              <asp:Button ID="Enviar" runat="server" CssClass="btn btn-outline-primary btn-lg" Text="Send" OnClick="Enviar_Click" />
